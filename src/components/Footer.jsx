            ...
            <div className="mx-auto max-w-screen-xl px-10 pb-0 pt-16">
                <div className="mb-10 grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-0">
                    ...
                    <div className="flex flex-col items-center md:items-end">
                        <div className="w-60">
                            ...
                            <Link to="/#contact" onClick={handelContact} className="text-nowrap mb-4 flex h-[55px] w-full items-center justify-center rounded-xl bg-orange-600 px-3 py-[5px] text-center text-sm font-semibold text-orange-50 transition-colors hover:bg-orange-700 sm:mr-0 sm:px-8 sm:py-3 sm:text-lg" aria-label="Follow this link to reach me via email">
                                Contact me
                            </Link>
                            <a href={whatsappLink} ref={ref} target="_blank" className="text-nowrap flex h-[55px] w-full items-center justify-center gap-3 rounded-xl bg-green-600 px-3 py-[5px] font-semibold text-green-50 transition-colors hover:bg-green-700 sm:mr-0 sm:px-8 sm:py-3 sm:text-lg" aria-label="Follow this link to reach me on whatsapp">
                                <span className="inline-block w-10">
                                    <img loading="lazy" className="h-full w-full object-cover" src={whatsappIcon} alt="The Social Media WhatsApp icon" />
                                </span>
                ...
                <div className="flex flex-col-reverse items-center justify-between gap-10 py-10 md:flex-row md:gap-0">
                    ...
                    <div className="flex h-full grid-cols-10 items-center justify-end gap-4 text-slate-500 md:gap-2">
                        {/* LinkedIn Logo Icon*/}
                        <SocialIcon link={linkedInLink} label="LinkedIn">
                        ...
                        {/* X Logo Icon*/}
                        <SocialIcon link={twitterLink} label="Twitter (X)">
                        ...
                        {/* FaceBook Logo Icon*/}
                        <SocialIcon link={facebookLink} label="Facebook">
                        ...
                        {/* Github Logo Icon*/}
                        <SocialIcon link={githubLink} label="Github">
                        ...
                        {/* WhatsApp Logo Icon*/}
                        <SocialIcon link={whatsappLink} label="Whatsapp">
...
function SocialIcon({ children, link = '#', label = '' }) {
    return (
        <a href={link} target="_blank" className="flex aspect-square items-center justify-center rounded-md border-2 border-slate-500/50 p-2 transition-colors duration-300 hover:border-orange-300 hover:text-orange-600" aria-label={"Follow this link to reach me on " + label}>
            {children}
        </a>
    )
}
