...
import filezillaIcon from "./assets/imgs/icons/filezilla.svg";
import javascriptIcon from "./assets/imgs/icons/javascript.svg";
...
const iconsData = {
    ...
    html: {
        icon: htmlIcon,
        site_url: "https://www.w3schools.com/html/",
    },
    jquery: {
        icon: jqueryIcon,
    ...
    bootstrap: {
        icon: bootstrapIcon,
        site_url: "https://getbootstrap.com",
    },
    css3: {
        icon: css3Icon,
        site_url: "https://www.w3.org/Style/CSS/Overview.en.html",
    },
    css: {
        icon: css3Icon,
        site_url: "https://www.w3.org/Style/CSS/Overview.en.html",
    ...
    filezilla: {
        icon: filezillaIcon,
        site_url: "https://filezilla-project.org/",
    },
    js: {
        icon: javascriptIcon,
        site_url: "https://www.javascript.com/",
    },
    ts: {
        icon: typescriptIcon,
    ...
    windows: {
        icon: windowsIcon,
        site_url: "https://www.microsoft.com/en-us/windows/",
    },
    composer: {
        icon: composerIcon,
        site_url: "https://getcomposer.org/",
    },
    premierepro: {
    ...
    vscode: {
        ...
        site_url: "https://code.visualstudio.com/",
    },
    apache: {
        icon: apacheIcon,
        site_url: "https://httpd.apache.org/",
    },
    "react.js": {
        icon: reactIcon,
